...
//    public static boolean DEBUG = false;
  ...
  /*           +"<script type=\"text/javascript\" src=\"/js/angular-permeagility.js\"></script>\n"
            ...
            +"  });\n</script>\n" */
            + getSortTableScript()
            + getDateControlScript(con.getLocale()) 
            + getColorControlScript() 
            + getD3Script() 
            + getCodeEditorScript() 
            + getSplitScript()
            + script + "\n"
  ...
  public String headMinimum(DatabaseConnection con, String title) {
    return "<head>\n" + "<meta http-equiv=\"Content-Type\" content=\"text/html; charset="+CHARACTER_ENCODING+"\">\n"
        + "<meta http-equiv=\"Pragma\" content=\"no-cache\">\n" + "<meta http-equiv=\"Expires\" content=\"-1\">\n"
        + "<meta http-equiv=\"Cache-Control\" content=\"no-cache\">\n"
        + "<meta name=\"GENERATOR\" content=\"HTML Document generated by PermeAgility\">\n" 
    ...
    public static String formHTMX(String n, String action, String method, String s) { return formHTMX(n, action, method, s, ""); }
    public static String formHTMX(String n, String action, String method, String s, String extraFormAttributes) {
    ...
    public static String linkHTMX(String ref, String desc, String extra) {
        return "<a hx-target=\"#service\" hx-trigger=\"click\" hx-swap=\"innerHTML\" hx-get=\"" 
                + ref + "\" "+extra+" >" + desc + "</a>\n";
    }
